...
R2Site.controller('LoginCtrl', [
    ...
    function(
        ...
        $scope.forgotPassword = function() {
            ...
            ForgotPassFactory.get({
                user: $scope.user.user
            }, function(result) {
                console.log('forgt. res', result);

                if (result.success) {
                    Notification.success({

                        message: 'Verifique o seu e-mail para recadastrar uma nova senha.',
...
R2Site.controller('RecadastrarSenhaCtrl', [
    ...
    function(
        ...
        $scope.updatePassword = function() {
            ...
            UsersFactory.save({
                data: $scope.user,
                activationKey: $stateParams.key,
                recadastrarSenha: true
            }, function(result) {
