        ...
        StoresFactory.show(function(result) {
            ...
            if (result.success) {
                ...
                $scope.storesDeptLancamento = _.filter(result.data, function (store) {
                    if (store.product.isLaunch !== undefined) {
...
.controller('BannerCtrl', [
    ...
    function ($scope, $timeout) {
        ...
        $scope.slides = [
            {image: '/img/banners/1.jpg', description: 'Imagem 1'},
            {image: '/img/banners/2.jpg', description: 'Imagem 2'},
            {image: '/img/banners/3.jpg', description: 'Imagem 3'},
        ];
