...
R2Site.controller('ComprarProdutoCtrl',[
    ...
    function ($scope, ngCart, $state) {
        ...
        console.log('COMPRAR PRODUTO CTRL');
            ...
            if (newVal !== undefined) {
                ...
                PagSeguroDirectPayment.getInstallments({
                    ...
                    success: function(result) {
                        ...
                        $scope.options.installments = result.installments[newVal.toLowerCase()].slice(0,10);
...

                {
                    ...
                    if (result.success) {
                        ...
                        ngDialog.openConfirm({
                            ...
                            template: '<p>O Número do Seu Pedido: ' + result.pedidoId + '</p>' +
