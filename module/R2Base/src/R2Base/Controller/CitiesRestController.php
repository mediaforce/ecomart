...
class CitiesRestController extends AbstractRestfulController {
	public function __construct(\Doctrine\ORM\EntityManager $em) {
		$this->em = $em;
		$this->repository = "R2Base\Entity\City";
	...
	public function getList() {
		if (isset($_GET['stateId'])) {
			$data = $this->em->getRepository('R2Base\Entity\City')->findBy(array('state' => (int) $_GET['stateId'] ));
			...
			return new JsonModel(array('success' => false, 'error' => 'STATE ID NOT FOUND'));
		}
