...
class Product {
	 ...
	 *      joinColumns={@ORM\JoinColumn(name="product_id", referencedColumnName="id")},
	 *      inverseJoinColumns={@ORM\JoinColumn(name="testmony_id", referencedColumnName="id")}
	 *      )
	 **/
	private $testimonies;
	/**
	 ...
	 *      joinColumns={@ORM\JoinColumn(name="product_id", referencedColumnName="id")},
	 *      inverseJoinColumns={@ORM\JoinColumn(name="product_rating_id", referencedColumnName="id")}
	 *      )
	 */
	 ...
	 *      joinColumns={@ORM\JoinColumn(name="product_id", referencedColumnName="id")},
	 *      inverseJoinColumns={@ORM\JoinColumn(name="alternate_produto_id", referencedColumnName="id")}
	 *      )
	 **/
     ...
     *
     * @param mixed $productGuide the product guide
     *
     * @return self
     */
