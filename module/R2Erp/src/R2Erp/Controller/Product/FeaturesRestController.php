...
class FeaturesRestController extends AbstractRestfulController {

	public function __construct($em, $service) {
		$this->em = $em;
		$this->service = $service;
		$this->repository = "R2Erp\Entity\Product\FeatureTag";
	...
	private function prepareDataToInsert($data) {
		$data['group'] = $this->em->getRepository('R2Erp\Entity\Product\FeatureGroup')->find($data['group']);
