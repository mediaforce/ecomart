...
return new JsonModel(array('data' => array('success' => false)));
	...
	public function update($id, $data) {
		...
		if ( isset($data['data']['dateDelivery']) ) {
			...
			if ($data['data']['order']['codRastreio'] != null ) {
				$orderToSave['codRastreio'] = $data['data']['order']['codRastreio'];
			}

			//return new JsonModel(array('success' => true, 'codRastreio' => $orderToSave['codRastreio']));
